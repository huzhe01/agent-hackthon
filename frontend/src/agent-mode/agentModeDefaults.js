export const fallbackModels = [
  { id: 'gpt-5', label: 'gpt-5', enabled_by_default: true, provider: 'Qiji' },
  { id: 'gpt-5.5', label: 'gpt-5.5', enabled_by_default: false, provider: 'Qiji' },
  { id: 'gpt-5-mini', label: 'gpt-5-mini', enabled_by_default: false, provider: 'Qiji' },
  { id: 'qwen-max', label: 'qwen-max', enabled_by_default: false, provider: 'Qiji' },
  { id: 'deepseek-chat', label: 'deepseek-chat', enabled_by_default: false, provider: 'Qiji' },
];

export const fallbackDataSources = [
  { id: 'realtime_metrics', label: '实时数据', enabled_by_default: true },
  { id: 'trend_metrics', label: '趋势曲线', enabled_by_default: true },
  { id: 'campaigns', label: '投放计划', enabled_by_default: true },
  { id: 'diagnosis', label: '智能诊断', enabled_by_default: true },
  { id: 'product_ads', label: '商品投放', enabled_by_default: true },
  { id: 'creative_library', label: '素材库', enabled_by_default: true },
  { id: 'business_clues', label: '经营线索', enabled_by_default: true },
];

export const agentModeFallback = {
  phase: 'briefing',
  brief_fields: {
    budget: null,
    target_roas: null,
    ...
    frames: [
      {
        ...
        events: [
          { time: '20:00', agent: '经营信号', text: '开播预热，等待首批评论、点击和加购信号。', tone: 'cyan' },
        ],
        steps: [
  ...
  frames: [
    {
      ...
      events: [
        { time: '20:00', agent: '经营信号', text: '东南亚晚高峰开播，等待 TikTok 评论和 Shopee 加购信号。', tone: 'cyan' },
      ],
      steps: [
...
agentModeFallback.budget_projects = [
  {
    id: 'blender-us-live',
    name: '便携榨汁杯 · 美国直播',
    market: '美国 / USD',
      ...
      live_rooms: [
        {
          id: 'sea-creator',
          name: '手机壳直播间 A · 达人测评',
          market: 'TikTok Shop SEA',
          role: '前段种草与评论蓄水',
          budget: 1100,
          spent: 0,
          roas: '2.5-2.9',
          channel: 'TikTok 75% / Shopee 25%',
          risk: '低风险',
          status: '待启动',
        },
        {
